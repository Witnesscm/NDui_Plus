...
G.OptionList = { -- type, key, value, name, horizon, data, callback, tooltip, scripts
	...
	[5] = {
		...
		{1, "Skins", "MeetingHorn", "MeetingHorn"},
		{1, "Skins", "MerInspect", "MerInspect", true},
		{1, "Skins", "RareScanner", "RareScanner"},
		{1, "Skins", "ShadowDancer", "ShadowDancer", true},
		{1, "Skins", "SimpleAddonManager", "SimpleAddonManager"},
	...
	[6] = {
		...
		{1, "Misc", "GearAppearanceToggle", L["GearAppearanceToggle"], true, nil, nil, L["GearAppearanceToggleTip"]},
