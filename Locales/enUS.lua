...
L["DressUp"] = "Dressing Room Enhanced"
L["DressUpTip"] = "Add button to unequip all items."
L["QuickSpecSwap"] = "Quick Swap Spec"
L["QuickSpecSwapTip"] = "DoubleClick icon to swap spec."
...
L["MerchantItemlevel"] = "MerchantFrame Itemlevel"
