...
L["Auto Roll"] = "自动Roll点"
L["Loot Roll Settings"] = "Roll点增强设置"
...
L["ChatFrameAnchorReset"] = "检测到聊天框锚点错误，已重置聊天框至默认位置。"
...
L["WormholeHelper"] = "虫洞助手"
L["WormholeHelperTip"] = "显示准确的虫洞目的地。"
...
L["Learn All"] = "学习全部"
L["ExitPhaseDivingButton"] = "离开相位潜行按钮"
L["WrapsUpgradeTips"] = "鼠标中键可以打开 |cnIQ6:[雷什裹布]|r 升级界面。"
L["[ABBR] Raid Finder"] = "随机"
L["[ABBR] Normal"] = "PT"
L["[ABBR] Heroic"] = "H"
L["[ABBR] Mythic"] = "M"
L["[ABBR] Temple of the Jade Serpent"] = "青龙寺"
L["[ABBR] Stormstout Brewery"] = "风暴烈酒酿造厂"
L["[ABBR] Gate of the Setting Sun"] = "残阳关"
L["[ABBR] Shado-Pan Monastery"] = "影踪禅院"
L["[ABBR] Siege of Niuzao Temple"] = "围攻砮皂寺"
L["[ABBR] Mogu'shan Palace"] = "魔古山宫殿"
L["[ABBR] Scholomance"] = "通灵学院"
L["[ABBR] Scarlet Halls"] = "血色大厅"
L["[ABBR] Scarlet Monastery"] = "血色修道院"
L["[ABBR] Skyreach"] = "通天峰"
L["[ABBR] Bloodmaul Slag Mines"] = "血槌炉渣矿井"
L["[ABBR] Auchindoun"] = "奥金顿"
L["[ABBR] Shadowmoon Burial Grounds"] = "影月墓地"
L["[ABBR] Grimrail Depot"] = "恐轨车站"
L["[ABBR] Upper Blackrock Spire"] = "黑石塔上层"
L["[ABBR] The Everbloom"] = "永茂林地"
L["[ABBR] Iron Docks"] = "钢铁码头"
L["[ABBR] Eye of Azshara"] = "艾萨拉之眼"
L["[ABBR] Darkheart Thicket"] = "黑心林地"
L["[ABBR] Black Rook Hold"] = "黑鸦堡垒"
L["[ABBR] Halls of Valor"] = "英灵殿"
L["[ABBR] Neltharion's Lair"] = "奈萨里奥的巢穴"
L["[ABBR] Vault of the Wardens"] = "守望者地窟"
L["[ABBR] Maw of Souls"] = "噬魂之喉"
L["[ABBR] The Arcway"] = "魔法回廊"
L["[ABBR] Court of Stars"] = "群星庭院"
L["[ABBR] Return to Karazhan: Lower"] = "卡拉赞下层"
L["[ABBR] Cathedral of Eternal Night"] = "永夜大教堂"
L["[ABBR] Return to Karazhan: Upper"] = "卡拉赞上层"
L["[ABBR] Seat of the Triumvirate"] = "执政团之座"
L["[ABBR] Atal'Dazar"] = "阿塔达萨"
L["[ABBR] Freehold"] = "自由镇"
L["[ABBR] Tol Dagor"] = "托尔达戈"
L["[ABBR] The MOTHERLODE!!"] = "暴富矿区"
L["[ABBR] Waycrest Manor"] = "维克雷斯庄园"
L["[ABBR] Kings' Rest"] = "诸王之眠"
L["[ABBR] Temple of Sethraliss"] = "塞塔里斯神庙"
L["[ABBR] The Underrot"] = "地渊孢林"
L["[ABBR] Shrine of the Storm"] = "风暴神殿"
L["[ABBR] Siege of Boralus"] = "围攻伯拉勒斯"
...
L["[ABBR] Priory of the Sacred Flame"] = "圣焰隐修院"
L["[ABBR] The Rookery"] = "驭雷栖巢"
L["[ABBR] The Stonevault"] = "矶石宝库"
L["[ABBR] City of Threads"] = "千丝之城"
L["[ABBR] Ara-Kara, City of Echoes"] = "回响之城"
L["[ABBR] Darkflame Cleft"] = "暗焰裂口"
L["[ABBR] The Dawnbreaker"] = "破晨号"
L["[ABBR] Cinderbrew Meadery"] = "燧酿酒庄"
L["[ABBR] Grim Batol"] = "格瑞姆巴托"
L["[ABBR] Operation: Floodgate"] = "水闸行动"
L["[ABBR] The Stonecore"] = "巨石之核"
L["[ABBR] Eco-Dome Al'dani"] = "生态圆顶"
L["[ABBR] Pit of Saron"] = "萨隆矿坑"
L["[ABBR] Windrunner Spire"] = "风行者之塔"
L["[ABBR] Magisters' Terrace"] = "魔导师平台"
L["[ABBR] Nexus-Point Xenas"] = "节点希纳斯"
L["[ABBR] Maisara Caverns"] = "迈萨拉洞窟"
L["[ABBR] The Blinding Vale"] = "夺目谷"
L["[ABBR] Voidscar Arena"] = "虚空之痕竞技场"
L["[ABBR] Den of Nalorakk"] = "纳洛拉克的洞穴"
L["[ABBR] Murder Row"] = "密谋小径"
L["[ABBR] Altar of Fangs"] = "毒牙祭坛"
L["[ABBR] Midnight Keystone Myth: Season 1"] = "S1 钥石神话"
L["[ABBR] Midnight Keystone Legend: Season 1"] = "S1 钥石传奇"
L["[ABBR] Midnight Keystone Hero: Season 1"] = "S1 钥石英雄"
L["[ABBR] Midnight Keystone Master: Season 1"] = "S1 钥石大师"
L["[ABBR] Midnight Keystone Legend: Season 2"] = "S2 钥石传奇"
L["[ABBR] Midnight Keystone Hero: Season 2"] = "S2 钥石英雄"
L["[ABBR] Midnight Keystone Master: Season 2"] = "S2 钥石大师"
L["[ABBR] Nerub-ar Palace"] = "尼鲁巴尔王宫"
L["[ABBR] Liberation of Undermine"] = "解放安德麦"
L["[ABBR] Manaforge Omega"] = "法力熔炉：欧米伽"
L["[ABBR] The Dreamrift"] = "梦境裂隙"
L["[ABBR] The Voidspire"] = "虚影尖塔"
L["[ABBR] March on Quel'Danas"] = "进军奎尔丹纳斯"
L["[ABBR] Sporefall"] = "孢陨幽境"
L["[ABBR] The Tidebound Grotto"] = "潮缚石窟"
